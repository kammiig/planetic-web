...
class SeoMetaSeeder extends Seeder
{
    ...
    {
        $pages = [
            ['page_key' => 'home', 'label' => 'Homepage', 'meta_title' => 'Premium Hosting, Domains & Bespoke Websites', 'meta_description' => 'UK domains, fast cPanel hosting, and a complete bespoke website for :price with a free domain and hosting for the first year — built, secured and managed for you by Planetic Web.'],
            ...
            ['page_key' => 'website-package', 'label' => 'Website package', 'meta_title' => 'Complete Bespoke Website for :price', 'meta_description' => 'A complete, custom-built website for :price including a free domain and hosting for the first year. Designed, built, secured and launched for you by Planetic Web.'],
